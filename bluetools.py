...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Type to talk with Blue, and attach images or documents for him to look at. &nbsp;<a href="/">← Home</a> &nbsp; <a href="/calendar">Calendar</a> &nbsp; <a href="/documents">Documents</a></p>
        </div>
    ...
    <div class="wrap">
        <div class="topbar">
            <div class="title-group">
                <h1>Calendar</h1>
                <div class="links"><a href="/">Home</a><a href="/chat">Chat</a><a href="/documents">Documents</a></div>
            </div>
            <div class="nav">
