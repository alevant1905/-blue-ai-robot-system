...
from blue.server.pages.head import HEAD_HTML
...
from blue.server.pages.head import OHBOT_HEADS_JS
...
from blue.server.pages.head import HEADS_HTML
...
from blue.server.pages.assets import BLUE_CSS


from blue.server.pages.assets import BLUE_JS
