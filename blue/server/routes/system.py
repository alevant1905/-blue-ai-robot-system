        ...
        <body>
            <div class="hub">
                ...
                <div class="tiles">
                    ...
                    <a class="tile" href="/bluej"><div class="ticon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21 12a8 8 0 0 1-11.5 7.2L4 20l1-4.5A8 8 0 1 1 21 12z"/><path d="M12 7v5l3 2"/></svg></div><h2>Blue-J</h2><p>Blue with memory, tools, and a live J-space.</p><div class="arrow">Open &rarr;</div></a>
