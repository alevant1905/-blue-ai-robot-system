...
def _process_reflection_job(job: Dict[str, Any]) -> None:
    ...
    system_prompt = (
        ...
        "— how I think, what I care about, how I have changed since I began. It "
        "accumulates: carry it forward, revising or adding at most one clause per "
        "pass, and only when the episodes genuinely warrant it. Never rewrite "
        "IDENTITY around the latest exchange, never reduce it to my current task, "
        "and never erase accumulated self-knowledge to make room for the moment. "
...
def _jspace_context_block() -> str:
    ...
    return (
        ...
        "this amounts to subjective experience is an open question. The numeric "
        ...
        "earlier reply text back to Alex.\n\n"
