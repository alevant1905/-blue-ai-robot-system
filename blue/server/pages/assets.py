...
(function(){
  ...
  var ICONS = {
    ...
    panel:'<svg viewBox="0 0 24 24"><circle cx="5" cy="7" r="2.5"/><circle cx="12" cy="5" r="2.5"/><circle cx="19" cy="7" r="2.5"/><path d="M2 14c0-2 1.5-3.5 3-3.5S8 12 8 14m1-1c0-2 1.5-3.5 3-3.5s3 1.5 3 3.5m1 1c0-2 1.5-3.5 3-3.5s3 1.5 3 3.5M5 17h14"/></svg>',
